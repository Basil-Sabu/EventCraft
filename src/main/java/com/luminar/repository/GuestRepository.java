...
public interface GuestRepository extends JpaRepository<Guest, Long> {
	...
	// DUPLICATE CHECK (ADD)
	// ===============================
	boolean existsByEventEventIdAndGroupNameIgnoreCase(Long eventId, String groupName);

	// ===============================
	// DUPLICATE CHECK (UPDATE)
	// ===============================
	boolean existsByEventEventIdAndGroupNameIgnoreCaseAndGroupIdNot(Long eventId, String groupName, Long groupId);
	...
	// Client → Event → Guest Groups
	List<Guest> findByEventEventIdAndEventClientUserId(Long eventId, Long userId);
